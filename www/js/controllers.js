myApp.controller('calculateCtrl', function($scope,igg) {
	...
	$.ajax({
    type: "get",
    url: "https://spreadsheets.google.com/feeds/list/1Su8cajlsyRYssKkuOiBuDAVrO8h6hIxlr0ucl1ahsZQ/od6/public/values?alt=json-in-script",
    dataType: "jsonp",
...
myApp.controller('calculate2Ctrl', function($scope,igg,$timeout,$ionicLoading,$ionicScrollDelegate) {
	...
	$.ajax({
    type: "get",
    url: "https://spreadsheets.google.com/feeds/list/1CvJhQMxeu6Jgh3-KHNXiAhGu5MpG45JkQa8sFwwxBTg/od6/public/values?alt=json-in-script",
    dataType: "jsonp",
	    success: function(json){
	        $scope.hero_skill_list =[];
	        _(json.feed.entry).each(function (item) {
